...
const BrutalistModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "paper-dark-texture border-2 border-[#e03d27] p-6 max-w-md w-full shadow-2xl btn-chamfer animate-in fade-in zoom-in-95 duration-200",
    role: "alertdialog",
    "aria-modal": "true",
    ...
    className: "w-2.5 h-2.5 bg-[#e03d27] rounded-full animate-pulse"
  }), /*#__PURE__*/React.createElement("span", {
    id: "notice-title",
  ...
  switch (name) {
    ...
    case 'SPOTIFY':
      return /*#__PURE__*/React.createElement("svg", {
        ...
        d: "M12 0C5.376 0 0 5.376 0 12s5.376 12 12 12 12-5.376 12-12S18.624 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141 C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.18-.1.2-1.02-.36-.18-.6.36-1.02 1.02-1.2 4.2-1.261 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"
      }));
    case 'INSTAGRAM':
      return /*#__PURE__*/React.createElement("svg", {
    ...
    case 'DROPBOX':
      return /*#__PURE__*/React.createElement("svg", {
        ...
        d: "M6 2l6 3.927L6 9.854 0 5.927 6 2zm12 0l6 3.927-6 3.927-6-3.927L18 2zM0 13.78l6-3.927 6 3.927-6 3.927-6-3.927zm24 0l-6-3.927-6 3.927 6 3.927 6-3.927zM6 19.162l6-3.927 6 3.927-6 3.927-6-3.927z"
      }));
    case 'FACEBOOK':
      return /*#__PURE__*/React.createElement("svg", {
    ...
    case 'GITHUB':
      return /*#__PURE__*/React.createElement("svg", {
        className: `${className} text-white hover:text-zinc-300 transition-colors`,
        viewBox: "0 0 24 24",
        fill: "currentColor"
      }, /*#__PURE__*/React.createElement("path", {
        fillRule: "evenodd",
...
const RigCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `paper-dark-texture border border-white/10 p-6 md:p-8 shadow-2xl relative overflow-hidden ${className}`
  }, children);
};
const PlatformCard = ({
  platform
  ...
  "aria-label": `${platform.label}: ${platform.capability}`
}, /*#__PURE__*/React.createElement(PlatformIcon, {
  name: platform.name,
  className: "w-6 h-6 mb-2"
}), /*#__PURE__*/React.createElement("span", {
  className: "font-mono font-bold text-[10px] text-white"
}, platform.label), /*#__PURE__*/React.createElement("span", {
...
const SavewaveApp = () => {
    ...
    try {
      ...
      for (let sourceIndex = 0; sourceIndex < sourceUrls.length; sourceIndex += 1) {
        try {
          ...
          if (completed.state === 'error') throw Object.assign(new Error(completed.errorMessage || 'Download failed.'), {
      ...
      const message = error.name === 'AbortError' ? 'Download preparation took too long. Please retry.' : error.message && error.message !== error.code ? error.message : normalized.message;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement(BrutalistModal, {
    ...
    className: "font-bold tracking-tighter text-lg sm:text-xl text-black"
  }, "SAVEWAVE")), /*#__PURE__*/React.createElement("div", {
    className: "hidden md:flex items-center gap-8 font-mono text-xs uppercase tracking-widest text-black/80 font-semibold"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => navigateToTab('downloader'),
    className: `nav-link-item ${activeTab === 'downloader' ? 'active-nav text-black' : ''}`
  }, "Downloader"), /*#__PURE__*/React.createElement("button", {
    onClick: () => navigateToTab('history'),
    className: `nav-link-item ${activeTab === 'history' ? 'active-nav text-black' : ''}`
  }, "Local History"), /*#__PURE__*/React.createElement("button", {
    onClick: () => navigateToTab('privacy'),
    className: `nav-link-item ${activeTab === 'privacy' ? 'active-nav text-black' : ''}`
  }, "Privacy")), /*#__PURE__*/React.createElement(RigButton, {
    variant: "primary",
    className: "px-4 sm:px-6",
    onClick: () => navigateToTab('downloader')
  }, "OPEN APP")), /*#__PURE__*/React.createElement("div", {
    className: "mobile-tabs relative z-20 md:hidden",
    "aria-label": "Application sections"
  }, ['downloader', 'history', 'privacy'].map(tab => /*#__PURE__*/React.createElement("button", {
    key: tab,
    type: "button",
    ...
    className: "text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-black leading-tight mb-5 md:mb-6"
    ...
    onClick: () => navigateToTab('history')
  }, "LOCAL HISTORY"))), /*#__PURE__*/React.createElement("div", {
    className: "lg:col-span-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "paper-dark-texture border border-white/15 p-5 md:p-7 shadow-2xl btn-chamfer"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center mb-6"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-[10px] uppercase tracking-widest text-[#e03d27] font-bold border border-[#e03d27]/40 px-2.5 py-0.5 bg-[#e03d27]/10"
  }, "SUPPORTED SOURCES"), /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-[10px] text-zinc-500 font-semibold"
  }, "AUTO DETECT")), /*#__PURE__*/React.createElement("div", {
    className: "platform-grid mb-6"
  }, SUPPORTED_PLATFORMS.map(platform => /*#__PURE__*/React.createElement(PlatformCard, {
    key: platform.name,
    platform: platform
    ...
    key: `tab-${activeTab}`,
    className: "max-w-5xl mx-auto tab-page-transition"
  }, activeTab === 'downloader' && /*#__PURE__*/React.createElement(RigCard, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "CLEAR")), platformInfo && /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-1.5 bg-[#e03d27]/20 border border-[#e03d27]/40 text-[#e03d27] px-2.5 py-1 text-xs font-mono select-none"
  }, /*#__PURE__*/React.createElement(PlatformIcon, {
    ...
    name: platformInfo.icon
  }), /*#__PURE__*/React.createElement("span", null, "AUDIO ONLY SOURCE DETECTED")) : /*#__PURE__*/React.createElement("div", {
  ...
  }, "CLEAR HISTORY")), clientHistory.length === 0 ? /*#__PURE__*/React.createElement("p", {
    className: "font-mono text-xs text-zinc-600"
  }, "No downloads yet.") : /*#__PURE__*/React.createElement("div", {
    className: "history-list flex flex-col gap-3"
  }, clientHistory.slice(0, visibleHistoryCount).map((item, i) => /*#__PURE__*/React.createElement("div", {
    key: item.id || `${item.timestamp}-${i}`,
    className: "bg-[#0d0d0e] border border-white/10 p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 card-hover-lift"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    variant: "outline",
    className: "self-center mt-3 py-3 px-6",
    onClick: () => setVisibleHistoryCount(count => Math.min(count + HISTORY_PAGE_SIZE, clientHistory.length))
    ...
    className: "font-bold text-white tracking-widest text-sm"
  }, "SAVEWAVE ", /*#__PURE__*/React.createElement("span", {
    className: "text-zinc-500 font-normal"
  }, "v", appVersion))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-6 text-[11px] text-zinc-400"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => navigateToTab('downloader'),
    ...
    src: "https://www.google.com/s2/favicons?domain=kuberbassi.com&sz=64",
    className: "w-4 h-4 rounded-full",
    alt: "kuberbassi.com favicon"
  })), /*#__PURE__*/React.createElement("div", {
